...
namespace CapaDatos
{
	...
	public partial class SOLUCIONCUESTIONARIO : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private long _IDSOLUCIONCUESTIONARIO;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnIDSOLUCIONCUESTIONARIOChanging(long value);
    ...
    partial void OnFECHAMODIFICACIONCUESTIONARIOChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IDSOLUCIONCUESTIONARIO", AutoSync=AutoSync.OnInsert, DbType="BigInt NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public long IDSOLUCIONCUESTIONARIO
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FECHAMODIFICACIONCUESTIONARIO", DbType="Date")]
		public System.Nullable<System.DateTime> FECHAMODIFICACIONCUESTIONARIO
		{
			get
			{
				return this._FECHAMODIFICACIONCUESTIONARIO;
			}
			set
			{
				if ((this._FECHAMODIFICACIONCUESTIONARIO != value))
				{
					this.OnFECHAMODIFICACIONCUESTIONARIOChanging(value);
					this.SendPropertyChanging();
					this._FECHAMODIFICACIONCUESTIONARIO = value;
					this.SendPropertyChanged("FECHAMODIFICACIONCUESTIONARIO");
					this.OnFECHAMODIFICACIONCUESTIONARIOChanged();
				}
			}
		}
