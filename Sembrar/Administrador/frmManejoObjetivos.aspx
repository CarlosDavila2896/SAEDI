...
<table style="width:100%;" __designer:mapid="192">
    ...
    <tr __designer:mapid="1ab">
        <td __designer:mapid="1ac" colspan="3" class="auto-style1">
            <asp:GridView ID="gvObjetivos" runat="server" Width="100%" AutoGenerateColumns="False" DataSourceID="odsObjetivos" DataKeyNames="IDOBJETIVO" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" AllowPaging="True" PageSize="15" >
                <Columns>
