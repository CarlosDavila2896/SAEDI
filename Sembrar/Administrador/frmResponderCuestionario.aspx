<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador/PrincipalAdministrador.Master" AutoEventWireup="true" CodeBehind="frmResponderCuestionario.aspx.cs" Inherits="Sembrar.Administrador.frmResponderCuestionario" %>
                                ...
                                <ContentTemplate>
                                    <table class="auto-style4">
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style3">
                                                <asp:DropDownList ID="ddlOrientador" runat="server" DataSourceID="odsOrientador" DataTextField="NOMBREORIENTADOR" DataValueField="IDORIENTADOR" OnSelectedIndexChanged="ddlOrientador_SelectedIndexChanged" Width="70%" AutoPostBack="True">
                                                </asp:DropDownList>
                                                <asp:ObjectDataSource ID="odsOrientador" runat="server" SelectMethod="D_consultarOrientadoresNombresCompletos" TypeName="CapaDatos.clsDOrientador"></asp:ObjectDataSource>
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="auto-style3">
                                                <asp:DropDownList ID="ddlPeriodo" runat="server" DataSourceID="odsPeriodo" DataTextField="NOMBREPERIODO" DataValueField="IDPERIODO" OnSelectedIndexChanged="ddlPeriodo_SelectedIndexChanged" Width="70%" AutoPostBack="True">
                                                </asp:DropDownList>
                                                <asp:ObjectDataSource ID="odsPeriodo" runat="server" SelectMethod="consultarPeriodoActivo" TypeName="CapaDatos.clsDPeriodo" OldValuesParameterFormatString="original_{0}"></asp:ObjectDataSource>
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="auto-style4" colspan="2">
                                                <asp:ListBox ID="lstIndividuos" runat="server" Width="100%" DataSourceID="odsIndividuos" DataTextField="NOMBRE" DataValueField="IDPERSONA" Rows="15" OnSelectedIndexChanged="lstIndividuos_SelectedIndexChanged"></asp:ListBox>
