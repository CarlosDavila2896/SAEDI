<%@ Page Title="" Language="C#" MasterPageFile="~/Orientador/PrincipalOrientador.Master" AutoEventWireup="true" CodeBehind="frmModificarCuestionario.aspx.cs" Inherits="Sembrar.Orientador.frmModificarCuestionario" EnableSessionState="True" %>
                ...
                <table id="crearObjetivo" class="auto-style4">
                    ...
                    <tr>
                        <td class="auto-style1">
                            <asp:Button ID="btnGenerar" runat="server" OnClick="btnGenerar_Click" Text="Generar" style="height: 26px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style1">
