<%@ Page Title="" Language="C#" MasterPageFile="~/Tecnico/PrincipalTecnico.Master" AutoEventWireup="true" CodeBehind="frmModificarCuestionario.aspx.cs" Inherits="Sembrar.Tecnico.frmModificarCuestionario" %>
                                    ...
                                    <table class="auto-style4">
                                        <tr>
                                            ...
                                            <td class="auto-style3">
                                                <asp:DropDownList ID="ddlProceso" runat="server" CssClass="auto-style5" DataSourceID="odsProceso" DataTextField="NOMBREPROCESO" DataValueField="IDPROCESO" OnSelectedIndexChanged="ddlProceso_SelectedIndexChanged" Height="19px" Width="70%" AutoPostBack="True">
                                                </asp:DropDownList>
